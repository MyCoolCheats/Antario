...
{
	const char* yTypes[] = {
		"SLOW SPIN", "FAST SPIN", "SPIN RANDOM", "JITTER", "CASUAL JITTER", "RANDOM BACKJITTER", "BACK JITTER", "SIDE", "BACKWARDS", "FORWARDS", "LEFT", "RIGHT", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LOWERBODY", "LBY JITTER", "LBY ON GROUND", // safe
