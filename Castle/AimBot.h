...
namespace Aimbot
{
	...
	void RCS(Vector& angle, C_BasePlayer* player, CUserCmd* cmd);
	void AimStep(C_BasePlayer* player, Vector& angle, CUserCmd* cmd);
	void Smooth(C_BasePlayer* player, Vector& angle, CUserCmd* cmd);
